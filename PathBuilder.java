...
//		for(Node node: nodes) {
//			System.out.println(node.number+" "+Arrays.toString(preprocess.unreachableDelNodesFromNode.get(node.number)));
//		}
//		System.exit(0);
	}
...
//		System.out.println("Number of paths:" + processed.size());
	...
	private boolean dominateLabel(Label L1, Label L2) {
		if(L1.time-zeroTol<=L2.time && L1.profit+zeroTol>=L2.profit && L1.node.number == L2.node.number) {
